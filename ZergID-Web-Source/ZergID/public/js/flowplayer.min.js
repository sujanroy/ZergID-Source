...
e.fn.flowplayer=function(t,n){
    return"string"==typeof t&&(t={
        ...
        var b=m||{
            conf:o,
            currentSpeed:1,
            volumeLevel:"undefined"==typeof o.volume?1*f.volume:o.volume,
            video:{},
            disabled:!1,
            finished:!1,
            loading:!1,
    ...
    return e.each(["autoplay","loop","preload","poster"],function(e,t){
        ...
        }),u.push(b),b.engine?(o.splash?b.unload():b.load(),o.disabled&&b.disable(),a.volume(b.volumeLevel),r.one("ready",n),void 0):b.trigger("error",{
    ...
    e.extend(n,{
        ...
        fullscreen:!u&&("function"==typeof document.webkitCancelFullScreen&&!/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(o)||document.mozFullScreenEnabled||"function"==typeof document.exitFullscreen),
    ...
    load:function(l){
        ...
        if(is_absolute=/^https?:/.test(c),u.length>0&&flowplayer.support.video&&u[0].pause(),u.remove(),is_absolute||s.rtmp||(c=e("<img/>").attr("src",c)[0].src),o)o.__play(c);
        else{
            ...
            i.data("origin")&&(f.origin=i.data("origin")),is_absolute&&delete s.rtmp,e.each(["key","autoplay","preload","rtmp","loop","debug","preload","splash"],function(e,t){
                ...
                try{
                    if(!o.PercentLoaded())return i.trigger("error",[n,{
                        code:7,
                        url:s.swf
                        }])
                    }catch(e){}
...
return n.bind("ready fullscreen fullscreen-exit",function(t){
    ...
    if(n.conf.flashfit||/full/.test(t.type)){
        ...
        (n.conf.flashfit||"fullscreen"===t.type)&&(o=n.video.width/n.video.height,s=n.video.height/n.video.width,h=Math.max(s*f),m=Math.max(o*p),h=h>p?m*s:h,h=Math.min(Math.round(h),p),m=m>f?h*o:m,m=Math.min(Math.round(m),f),g=Math.max(Math.round((p+g-h)/2),0),v=Math.max(Math.round((f+v-m)/2),0)),e("object",i).css({
            width:m,
            height:h,
            marginTop:g,
            marginLeft:v
            ...
            r.addEventListener(a,function(d){
                if("progress"==o&&d.srcElement&&0===d.srcElement.readyState&&setTimeout(function(){
                    ...
                    switch(o){
                        ...
                        if("progress"==o)return;case"speed":
                            u=n(r.playbackRate);
                            break;
                        case"volume":
                            u=n(r.volume);
...
load:function(n){
    if(p.splash&&!d)u=h(n).prependTo(i),c.inlineVideo||u.css({
        position:"absolute",
        top:"-9999em"
...
flowplayer(function(t,n){
    ...
    t.cuepoints=t.conf.cuepoints||[],t.bind("progress",function(e,r,o){
        ...
        for(var s,l=t.cuepoints||[],d=0;d<l.length;d++)s=l[d],isNaN(s)||(s={
            time:s
        }),s.time<0&&(s.time=t.video.duration+s.time),s.index=d,Math.abs(s.time-o)<.125*t.currentSpeed&&(i(d),n.trigger("cuepoint",[t,s]))
...
(flowplayer.support.touch||A)&&flowplayer(function(t,n){
    ...
    if(t.conf.embed!==!1){
        var i=t.conf,a=e(".fp-ui",n),r=e("<a/>",{
            "class":"fp-embed",
            title:"Copy to your site"
        }).appendTo(a),o=e("<div/>",{
            "class":"fp-embed-code"
        }).append("<label>Paste this HTML code on your site to embed.</label><textarea/>").appendTo(a),s=e("textarea",o);
        t.embedCode=function(){
            var a=t.video,r=a.width||n.width(),o=a.height||n.height(),s=e("<div/>",{
                "class":"flowplayer",
                css:{
                    width:r,
                    height:o
...
flowplayer(function(e,o){
    ...
    if("file:"==location.protocol&&(l="localhost"),e.load.ed=1,t.hostname=l,t.origin=i||location.href,i&&o.addClass("is-embedded"),"string"==typeof r&&(r=r.split(/,\s*/)),r&&"function"==typeof key_check&&key_check(r,l))t.logo&&o.append(n("<a>",{
        "class":"fp-logo",
        href:i
    }).append(n("<img/>",{
        src:t.logo
        ...
        n(".fp-controls",o),e.bind("pause resume finish unload",function(e,o){
            ...
            /pause|resume/.test(e.type)&&"flash"!=o.engine&&4!=a&&5!=a?(s.show().css({
                position:"absolute",
                left:16,
                bottom:36,
                zIndex:99999,
                ...
                }),o.load.ed=s.is(":visible"),o.load.ed||o.pause()):s.hide()
            })
        }
    });