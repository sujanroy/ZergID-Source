...
(function(t,e){
        ...
        function i(e){
            ...
            return o&&t.each(o.split(" "),function(e){
                ...
                t.each(this.split(","),function(e,i){
                    if("title"==i)a.append("<span class='fc-header-title'><p id='event_month' class='profile_title' style='color:#D1CFCF;'>&nbsp;</p></span>"),o&&o.addClass(v+"-corner-right"),o=null;
                    else{
                        var s;
    ...
    function q(t,e){
        e="number"==typeof e?e+"px":e,t.each(function(t,n){
            n.style.cssText+=";min-height:90px;_height:"+e
        })
    }
    function I(){}
    function Y(t,e){
