/*!
 * fullCalendar1 v1.6.1
 * Docs & License: http://arshaw.com/fullCalendar1/
 * (c) 2013 Adam Shaw
 */
(function(t,e){
    function n(e){
    ...
    function a(){
        ...
        return o&&t.each(o.split(" "),function(e){
            ...
            t.each(this.split(","),function(e,i){
                if("title"==i)a.append("<span class='fc-header-title'><p class='title' style='color:#ffffff; margin-bottom:20px; font-size:25pt;'>&nbsp;</p></span>"),o&&o.addClass(v+"-corner-right"),o=null;
                else{
                    var s;
...
function M(t){
    ...
    e="number"==typeof e?e+"px":e,t.each(function(t,n){
        n.style.cssText+=";min-height:35px;_height:"+e
        })
    }
    function I(){}
function Y(t,e){
...
function K(){
    ...
    function a(t,e,n){
        ...
        for(s+="<table class='fc-border-separate' style='width:100%; border-top: 1px solid #fff; border-right:1px solid #fff;' cellspacing='0'><thead><tr>",De&&(s+="<th class='fc-week-number "+c+"'/>"),r=0;re>r;r++)o=F(0,r),s+="<th class='fc-day-header fc-"+Se[o.getDay()]+" "+c+"'/>";
        for(s+="</tr></thead><tbody>",r=0;ne>r;r++){
            for(s+="<tr class='fc-week'>",De&&(s+="<td class='fc-week-number "+l+"'>"+"<div/>"+"</td>"),a=0;re>a;a++)o=F(r,a),i=["fc-day","fc-"+Se[o.getDay()],l],o.getMonth()!=u&&i.push("fc-other-month"),+o==+d&&(i.push("fc-today"),i.push(be+"-state-highlight")),s+="<td class='"+i.join(" ")+"'"+" data-date='"+Fe(o,"yyyy-MM-dd")+"'"+">"+"<div>",n&&(s+="<div class='fc-day-number'>"+o.getDate()+"</div>"),s+="<div class='fc-day-content'><div style='position:relative; margin-top:-2px'>&nbsp;</div></div></div></td>";
            s+="</tr>"
            }
...
function fe(){
    function n(t,e){
        ...
        for(e=0;d>e;e++)n=t[e],r=n.event,o=["fc-event-day","fc-event-hori"],w(r)&&o.push("fc-event-draggable"),n.isStart&&o.push("fc-event-start"),n.isEnd&&o.push("fc-event-end"),f?(i=A(n.end.getDay()-1),s=A(n.start.getDay()),c=n.isEnd?N(i):h,l=n.isStart?W(s):g):(i=A(n.start.getDay()),s=A(n.end.getDay()-1),c=n.isStart?N(i):h,l=n.isEnd?W(s):g),o=o.concat(r.className),r.source&&(o=o.concat(r.source.className||[])),a=r.url,u=Q(r,y),p+=a?"<a href='"+V(a)+"'":"<div",p+=" class='"+o.join(" ")+"'"+" style='position:absolute;z-index:8;left:"+c+"px;"+u+"'"+">"+"<div class='fc-event-inner'>",!r.allDay&&n.isStart&&(p+="<span class='fc-event-time'>"+V(I(r.start,r.end,y("timeFormat")))+"</span>"),p+="<span class='fc-event-title'>"+V(r.title)+"</span>"+"</div>",n.isEnd&&D(r)&&(p+="<div class='ui-resizable-handle ui-resizable-"+(f?"w":"e")+"'>"+"&nbsp;&nbsp;&nbsp;"+"</div>"),p+="</"+(a?"a":"div")+">",n.left=c,n.outerWidth=l-c,n.startCol=i,n.endCol=s+1;
        return p
        }
        function o(e,n){
...
t.fn.fullCalendar1=function(n){
    if("string"==typeof n){
        var a,o=Array.prototype.slice.call(arguments,1);
        return this.each(function(){
            var r=t.data(this,"fullCalendar1");
            if(r&&t.isFunction(r[n])){
                var i=r[n].apply(r,o);
                a===e&&(a=i),"destroy"==n&&t.removeData(this,"fullCalendar1")
                }
            }),a!==e?a:this
    }
...
return delete n.eventSources,n.events&&(i.push(n.events),delete n.events),n=t.extend(!0,{},ye,n.isRTL||n.isRTL===e&&ye.isRTL?be:{},n),this.each(function(e,a){
    ...
    o.data("fullCalendar1",s),s.render()
    }),this
