...
<span id="User_title" class="large_title">Manage User <span id="character_count"><?= count($user_list); ?></span> </span>
...
<div id="deleteduser_details_grid"></div>
<div id="deleteduser_details_grid_loading"></div>

  <div id="hide_user_grid">
      <div style="width:940px;" align="right"> <span class="radio_class"><input type="radio"  name="charaguildlist" value="1" checked="checked" class="checkbox" style="margin-right:10px;"><label for="character" style=" color: #71bdf0; font-size:15px;">Manage User</label></span> <span class="radio_class"><input type="radio"  name="charaguildlist" value="2" class="checkbox" onclick="Showdeletedlist('<?= URL::base(); ?>');" style="margin-right:10px;"><label for="evnt_members" style="font-size:15px;">Deleted User</label></span></div>
<?php if (count($user_list) > 0): ?>
    <div align="center">
        ...
        <table id="datatables" class="display" style="width:970px; margin-top:12px;">
            <thead>
                <tr id="data_header">
                    ...
                    <th  width="18%" style="width:130px;">Active/De-active</th>
            ...
            ?>
               ...
               <td width="15%">
               <p class="field" style="margin-top:20px">
		...
		<span id="disenable<?=$user->id; ?>" class="cb-disable <?=$deactive_class;?>" onclick="return deactiveuser(<?= $user->id ?>);"><span>De-active</span></span>
                 ...
                 <td><?= HTML::image("public/images/delete_icon.png", array('class' => 'delete_icon', 'id' => $user->id,
                    'alt' => $user->username,'onclick' => "deleteUser('".URL::site()."', '".$user->id."', '".$user->username."',this)"));
                        ?></td>
                </tr>
