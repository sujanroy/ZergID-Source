...
<div style="margin-top:30px; width:480px;">
         ...
         <div class="title">
            <?php if ($comment->character_name == "" || $comment->character_name == NULL):    
                     echo HTML::anchor('user/others/' . $comment->user_id, $comment->username); 
                 else: 
                     echo HTML::anchor('character/view/' . $comment->character_detail_id, $comment->character_name); ?> <span class="feed-charname"><?= $comment->username ?>'s Character</span>
             <?php endif; ?> 
         </div>
         <?php 
